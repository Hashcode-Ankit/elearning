    ...
    render() {
        return (
            <div className="py-20 sm:py-24 items-center" id="accelerator">
                ...
                <div className="flex justify-center items-center pt-20 sm:static sm:inset-auto">
                ...
                <div className="flex justify-end items-end pt-12 pr-20 sm:static sm:inset-auto">
