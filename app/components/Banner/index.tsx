                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly'>
                        <div className='flex gap-2 mx-auto lg:mx-0'>
                            ...
                            <h3 className='text-kellygreen text-sm font-semibold text-center lg:text-start'>Upto 50% off on first enroll</h3>
                        </div>
                        ...
                        <h3 className='text-charcoal text-lg font-normal text-center lg:text-start opacity-75 pt-10 lg:pt-5'>Build skills with our courses and mentor from world-class companies. We are on mission to prepare every individual for the job market, and become independent.</h3>
